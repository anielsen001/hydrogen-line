...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.limesdr_source_0 = limesdr.source('1D40F6375A17E0', 0, '', False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/data/record_chan1.bin', False)
